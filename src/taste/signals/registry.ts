...
export const TASTE_SIGNALS: readonly TasteSignalDef[] = [
  // --- breadth ---
  {
    ...
    description: "How many distinct platforms appear in evidence.",
    inputs: ["platforms"],
    weight: 0.4,
    status: "active",
    version: 1,
  ...
  },
  {
    ...
    description: "Spread across profile / post / video / channel styles.",
  ...
  },
  {
    ...
    description: "Less common combinations of topic buckets.",
    inputs: ["bios", "captions", "platforms"],
    weight: 0.45,
    status: "active",
    version: 1,
  },
  ...
  // --- coherence ---
  {
    ...
    description: "Same topic buckets appear on more than one platform.",
    inputs: ["bios", "captions", "platforms"],
    weight: 0.6,
    status: "active",
    version: 1,
